...
class image_features:
    ...
    def get_feats(self,mname,batch_size):
        fname,data_directory=self.get_data()
        n=len(fname)
        print(n)
        ...
        #print(features)
        s='imgfeature_' + str(batch_size) + '_final.pkl'
        pickle.dump([imgname,features],open(s,'wb'))
...
if __name__=='__main__':
    ...
    obj.get_feats(modelname,batch_size)  # Creates files with features --- final one: imgfeature_batchsize_final.pkl
